...
# print to test if transform of fields was working
# additional_fields.show(30)
...
# Conditions for the new strat I have to play. 
# ==0, 3
# ==2, 0
# >0, 6
# ==-2, 6
...
"""
Below is a more sophisticated solution provided by phind (lines 128 to 150). The question now is, which one has better performance with sizeable datasets? You can check the testing files for a surprise
"""
@udf(IntegerType())
